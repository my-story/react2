...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f73b4c93455541f38e4cdc4")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Spirituality </p>
                            <p id="categories-podcast">#Meditation </p>
                            <p id="categories-podcast">#MDMA </p>
                            <p id="categories-podcast">#Awakening </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/15938366/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
