...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f73b0fb3455541f38e4cdbb")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Natural </p>
                            <p id="categories-podcast">#Religion </p>
                             <p id="categories-podcast">#Life </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/15578246/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/"
                            width="80%"
                            height="95px"
