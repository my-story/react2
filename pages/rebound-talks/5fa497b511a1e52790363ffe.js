...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5fa497b511a1e52790363ffe")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Declutter </p>
                            <p id="categories-podcast">#Design </p>
                            <p id="categories-podcast">#Fear </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/16580309/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/"
                            width="80%"
                            height="95px"
