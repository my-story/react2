...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f206a5454c4be00174cc2c9")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Trauma </p>
                            <p id="categories-podcast">#Coach </p>
                            <p id="categories-podcast">#Narcissism </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/14762537/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
