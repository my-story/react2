...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5fa495ea11a1e52790363ff8")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#HIIT </p>
                            <p id="categories-podcast">#Health </p>
                            <p id="categories-podcast">#Psychology </p>
                            <p id="categories-podcast">#Exercise </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/16212239/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/"
                            width="80%"
                            height="95px"
