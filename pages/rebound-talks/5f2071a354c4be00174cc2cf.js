...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f2071a354c4be00174cc2cf")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#NoFear </p>
                            <p id="categories-podcast">#100daysOfFear </p>
                            <p id="categories-podcast">#Brave </p>
                            <p id="categories-podcast">#Resilience </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/15036701/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
