                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#MorningRoutine </p>
                            <p id="categories-podcast">#Purpose </p>
                            <p id="categories-podcast">#Jail </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/15213293/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/"
                            width="80%"
                            height="95px"
