...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f73b40c3455541f38e4cdc1")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Gerontologist </p>
                            <p id="categories-podcast">#Adversity </p>
                            <p id="categories-podcast">#Aging </p>
                            <p id="categories-podcast">#Science </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/15845852/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
