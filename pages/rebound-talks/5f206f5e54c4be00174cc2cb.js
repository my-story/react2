...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f206f5e54c4be00174cc2cb")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Surf </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/14850821/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/"
                            width="80%"
                            height="95px"
