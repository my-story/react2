                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#FOMO </p>
                            <p id="categories-podcast">#FOBO </p>
                            <p id="categories-podcast">#Psychology </p>
                            <p id="categories-podcast">#SocialMedia </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/14501696/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/"
                            width="80%"
                            height="95px"
