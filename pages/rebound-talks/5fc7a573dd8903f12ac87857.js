...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5fc7a573dd8903f12ac87857")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Procrastination </p>
                            <p id="categories-podcast">#Ultralearning </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/17033663/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
                    ...
                    <div className="show-notes-div">
                        ...
                        <ul className="show-notes-ul">
                            <li><a href="https://www.scotthyoung.com/blog/ultralearning/">Learn more about Ultralearning</a></li>
                            <li>Buy Book Here <a href="https://www.amazon.com/gp/product/006285268X/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=006285268X&linkCode=as2&tag=rebound0a-20&linkId=3b51ab2a3c285d6814d47224a42e5b1a">Ultralearning: Master Hard Skills, Outsmart the Competition, and Accelerate Your Career</a></li>
                            <li><a href="https://www.fluentin3months.com/">Benny Lewis</a></li>
                            <li>Scott on his <a href="https://www.scotthyoung.com/blog/myprojects/mit-challenge-2/">MIT CHALLENGE</a></li>
                            <li>Wanna learn to play the guitar with <a href="http://aboutthestart.com/">Tristan de Montebello</a></li>
