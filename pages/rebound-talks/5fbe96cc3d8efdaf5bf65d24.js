...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5fbe96cc3d8efdaf5bf65d24")
            .then((podcast) => {
        ...
        if (podcast === ""  ) {
            ...
            return(
                <div className="podcast-detail-page" height={height}>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/16955024/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
