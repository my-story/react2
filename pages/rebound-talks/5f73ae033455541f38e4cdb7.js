...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f73ae033455541f38e4cdb7")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#FakeNews </p>
                            <p id="categories-podcast">#Procrastination </p>
                            <p id="categories-podcast">#EndOfProcrastination </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/15401336/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/"
                            width="80%"
                            height="95px"
