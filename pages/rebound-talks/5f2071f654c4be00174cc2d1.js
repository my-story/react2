...
class PodcastDetail extends Component {
    ...
    fetchPodcast = () => {
        ...
        PodcastServices.getOne("5f2071f654c4be00174cc2d1")
            .then((podcast) => {
                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#COVID </p>
                            <p id="categories-podcast">#Spirituality </p>
                            <p id="categories-podcast">#Intuition </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/15124031/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
