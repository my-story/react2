                ...
                <div className="podcast-detail-page" height={height}>
                    ...
                    <div className="podcast-header-div">
                        <div className="podcast-categories">
                            <p id="categories-podcast">#Ultramarathon </p>
                            <p id="categories-podcast">#Runner </p>
                            <p id="categories-podcast">#Athlete </p>
                            <p id="categories-podcast">#Discipline </p>
                    ...
                    <Iframe url="//html5-player.libsyn.com/embed/episode/id/14437553/height/90/theme/custom/thumbnail/yes/direction/backward/render-playlist/no/custom-color/87A93A/" 
                            width="80%"
                            height="95px"
